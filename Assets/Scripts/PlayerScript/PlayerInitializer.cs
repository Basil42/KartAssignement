...
public class PlayerInitializer : MonoBehaviour
{
        ...
        [SerializeField] private string player1Scheme = "Player1";
        ...
        private void InitializePlayers()
        {
                ...
                int playerIndex = 0;
                var player1 =  PlayerInput.Instantiate(playerPrefab, playerIndex, player1Scheme, -1, Keyboard.current);
                player1.GetComponent<PlayerDataRefBroadcaster>().Data =
                        new PlayerData(playerIndex, player1Scheme, player1);
                playerIndex++;
